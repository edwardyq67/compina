  ...
  return (
    <nav className="fixed w-full z-20 top-0 start-0">
      <div className="bg-black">
         <div className="relative z-30 bg-black max-w-screen-xl flex flex-wrap items-center justify-between w-full mx-auto p-4">
        ...
        <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
          <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border rounded-lg bg-transparent md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0">
            <li>
              <a onClick={() => navigate("/")} className="cursor-pointer block py-2 px-3 text-mysin-400 rounded md:bg-transparent md:p-0" aria-current="page">
                Home
              </a>
            </li>
            <li>
            ...
            <li>
              <a onClick={() => navigate('/contact')} className="cursor-pointer block py-2 px-3 hover:text-mysin-400 transition-all duration-150 rounded md:hover:bg-transparent md:p-0 text-white md:dark:hover:bg-transparent">
                Contact
              </a>
            </li>
          </ul>
      ...
      <div
        className={`z-20 absolute inset-x-0 transition-transform rounded-b-lg duration-300 ease-in-out ${sale ? 'translate-y-0' : '-translate-y-full'} mt-0 md:hidden container mx-auto bg-black grid`}
        id="navbar-sticky"
      >
        <ul className="flex bg-black flex-col p-4 md:p-0 font-medium rounded-b-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0">
          <li>
            <a onClick={() => navigate("/")} className="cursor-pointer block py-2 px-3 transition-all duration-150 hover:bg-mysin-200 text-mysin-400 rounded md:bg-transparent md:p-0" aria-current="page">
              Home
            </a>
          </li>
          <li>
